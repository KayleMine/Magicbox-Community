...
local function getNumSpells()
    local _table = GetSpellTabInfo(GetNumSpellTabs())
    return _table.itemIndexOffset + _table.numSpellBookItems 
end
...
local function findSpellIdx(spellName)
    ...
    for i = 1, getNumSpells() do
        local spell, rank = C_SpellBook.GetSpellBookItemName(i, 0)
