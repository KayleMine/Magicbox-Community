...
fontObject:SetFont("Interface\\Addons\\Magicbox-Community\\butwhy\\core\\media\\Furore.otf", 9, "")
...
function dark_addon.log(string, ...)
  ...
  print('|cff' .. dark_addon.color .. '[MagicBox]|r ' .. formatted)
end

function dark_addon.error(...)
  print('|cff' .. dark_addon.color .. '[MagicBox]|r |cffc32425' .. join(...) .. '|r')
end
