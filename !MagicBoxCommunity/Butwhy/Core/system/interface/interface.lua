...
function _G.FlexIcon(spell, width, height)
	name = C_Spell.GetSpellInfo(spell).name
    return "\124T"..(C_Spell.GetSpellTexture(spell) or C_Spell.GetSpellTexture(24720))..":"..(height or 25)..":"..(width or 25).."\124t "..name 
end
function _G.FlexIconN(spell, width, height)
    return "\124T"..(C_Spell.GetSpellTexture(spell) or C_Spell.GetSpellTexture(24720))..":"..(height or 25)..":"..(width or 25).."\124t"	
end
local icons = {
  ['abacus'] = 0xf640,
  ['acorn'] = 0xf6ae,
...
function dark_addon.interface.icon(icon)
